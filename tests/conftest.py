...
# WARNING: Ensure imports from `fast_api_sandbox` comes after this line
from fast_api_sandbox import app, settings, db  # noqa
from fast_api_sandbox.cli import create_user, cli  # noqa
